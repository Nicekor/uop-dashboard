...
const NEWS_CATEGORIES = [
  {option: 'business', name: 'Business'},
  {option: 'entertainment', name: 'Entertainment'},
  {option: 'general', name: 'General'},
  {option: 'health', name: 'Health'},
  {option: 'science', name: 'Science'},
  {option: 'sports', name: 'Sports'},
  {option: 'technology', name: 'Technology'}
];
